        ...
        <div class="card p-4"
            ...
            <form action="" method="POST">
                ...
                <div class="form-group bg-transparent">
                    ...
                    <input type="datetime-local" class="form-control mb-3" id="timestamp" name="timestamp" required
                    ...
                    <label for="tahun_akademik" class="form-label fw-semibold mb-1" style=" font-size: 16px;">Tahun
                        Akademik</label>
                    <input type="text" class="form-control mb-3" id="tahun_akademik" name="tahun_akademik"
                        placeholder="Masukkan Tahun Akademik" oninput="this.value = this.value.replace(/[^0-9]/g, '')"
                        required
                        style="border-radius: 8px; padding: 12px; font-size: 16px; border: 1px solid #ddd; background: transparent;">
